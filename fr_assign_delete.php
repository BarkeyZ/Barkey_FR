		...
		<div class="span10 offset1">
			...
			<div class="form-horizontal" >
				...
				<div class="control-group">
					...
					<div class="controls">
						<label class="checkbox">
							<?php echo htmlspecialchars(trim($eventdata['event_description'])) . " (" . htmlspecialchars(trim($eventdata['event_location'])) . ") ";?>
						</label>
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<label class="checkbox">
							<?php echo htmlspecialchars(Functions::dayMonthDate($eventdata['event_date']) . ", " . Functions::timeAmPm($eventdata['event_time']));?>
						</label>
					</div>
				</div>
