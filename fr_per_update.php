...
if ( !empty($_POST)) { // if $_POST filled then process the form
	...
	if (empty($state) || strlen($state) != 2) {
		$stateError = 'Please enter valid state abbreviation, such as MI or OH';
		$valid = false;
	}
	if (empty($zip) || strlen($zip) != 5) {
		$stateError = 'Please enter valid 5 digit zip code';
		$valid = false;
	}
		...
		<div class="span10 offset1">
			...
			<form class="form-horizontal" action="fr_per_update.php?id=<?php echo $id?>" method="post" enctype="multipart/form-data">
				...
				<div class="control-group <?php echo !empty($addressError)?'error':'';?>">
					...
					<div class="controls">
						<input name="address" type="text"  placeholder="Street Address" value="<?php echo !empty($address)?$address:'';?>">
				...
				<div class="control-group <?php echo !empty($stateError)?'error':'';?>">
					...
					<div class="controls">
						<input name="state" type="text"  placeholder="Ex: MI" value="<?php echo !empty($state)?$state:'';?>">
