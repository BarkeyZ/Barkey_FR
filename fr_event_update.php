		...
		<div class="span10 offset1">
			...
			<form class="form-horizontal" action="fr_event_update.php?id=<?php echo $id?>" method="post">
				...
				<div class="control-group <?php echo !empty($dateError)?'error':'';?>">
					...
					<div class="controls">
						<input name="event_date" type="date"  placeholder="Date" value="<?php echo !empty($date)?htmlspecialchars($date):'';?>">
				...
				<div class="control-group <?php echo !empty($timeError)?'error':'';?>">
					...
					<div class="controls">
						<input name="event_time" type="time" placeholder="Time" value="<?php echo !empty($time)?htmlspecialchars($time):'';?>">
