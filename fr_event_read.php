		...
		<div class="span10 offset1">
			...
			<div class="form-horizontal" >
				...
				<div class="control-group">
					...
					<div class="controls">
						<label class="checkbox">
							<?php echo htmlspecialchars(Functions::dayMonthDate($data['event_date']));?>
						</label>
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<label class="checkbox">
							<?php echo htmlspecialchars(Functions::timeAmPm($data['event_time']));?>
						</label>
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<label class="checkbox">
							<?php echo htmlspecialchars($data['event_description']);?>
						</label>
					</div>
				</div>
